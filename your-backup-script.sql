...
--
-- Name: User; Type: SCHEMA; Schema: -; Owner: roza
...
ALTER SCHEMA "User" OWNER TO CURRENT_USER;
...
--
-- Name: _desc; Type: TABLE; Schema: public; Owner: roza
...
ALTER TABLE public._desc OWNER TO roza
;

--
-- Name: _desc_id_seq; Type: SEQUENCE; Schema: public; Owner: roza
...
ALTER SEQUENCE public._desc_id_seq OWNER TO roza
;

--
-- Name: _desc_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: roza
...
--
-- Name: card; Type: TABLE; Schema: public; Owner: roza
...
ALTER TABLE public.card OWNER TO roza
;

--
-- Name: card_card_id_seq; Type: SEQUENCE; Schema: public; Owner: roza
...
ALTER SEQUENCE public.card_card_id_seq OWNER TO roza
;

--
-- Name: card_card_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: roza
...
--
-- Name: horoscopes; Type: TABLE; Schema: public; Owner: roza
...
ALTER TABLE public.horoscopes OWNER TO roza
;

--
-- Name: horoscopes_horoscope_id_seq; Type: SEQUENCE; Schema: public; Owner: roza
...
ALTER SEQUENCE public.horoscopes_horoscope_id_seq OWNER TO roza
;

--
-- Name: horoscopes_horoscope_id_seq1; Type: SEQUENCE; Schema: public; Owner: roza
...
ALTER SEQUENCE public.horoscopes_horoscope_id_seq1 OWNER TO roza
;

--
-- Name: horoscopes_horoscope_id_seq1; Type: SEQUENCE OWNED BY; Schema: public; Owner: roza
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: roza
...
ALTER TABLE public.users OWNER TO roza
;

--
-- Name: users_user_id_seq; Type: SEQUENCE; Schema: public; Owner: roza
...
ALTER SEQUENCE public.users_user_id_seq OWNER TO roza
;

--
-- Name: users_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: roza
...
--
-- Name: usersы; Type: TABLE; Schema: public; Owner: roza
...
ALTER TABLE public."usersы" OWNER TO roza
;

--
-- Name: usersы_user_id_seq; Type: SEQUENCE; Schema: public; Owner: roza
...
ALTER SEQUENCE public."usersы_user_id_seq" OWNER TO roza
;

--
-- Name: usersы_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: roza
...
--
-- Name: _desc id; Type: DEFAULT; Schema: public; Owner: roza
...
--
-- Name: card card_id; Type: DEFAULT; Schema: public; Owner: roza
...
--
-- Name: horoscopes horoscope_id; Type: DEFAULT; Schema: public; Owner: roza
...
--
-- Name: users user_id; Type: DEFAULT; Schema: public; Owner: roza
...
--
-- Name: usersы user_id; Type: DEFAULT; Schema: public; Owner: roza
...
--
-- Data for Name: _desc; Type: TABLE DATA; Schema: public; Owner: roza
...
--
-- Data for Name: card; Type: TABLE DATA; Schema: public; Owner: roza
...
--
-- Data for Name: horoscopes; Type: TABLE DATA; Schema: public; Owner: roza
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: roza
...
--
-- Data for Name: usersы; Type: TABLE DATA; Schema: public; Owner: roza
...
--
-- Name: _desc_id_seq; Type: SEQUENCE SET; Schema: public; Owner: roza
...
--
-- Name: card_card_id_seq; Type: SEQUENCE SET; Schema: public; Owner: roza
...
--
-- Name: horoscopes_horoscope_id_seq; Type: SEQUENCE SET; Schema: public; Owner: roza
...
--
-- Name: horoscopes_horoscope_id_seq1; Type: SEQUENCE SET; Schema: public; Owner: roza
...
--
-- Name: users_user_id_seq; Type: SEQUENCE SET; Schema: public; Owner: roza
...
--
-- Name: usersы_user_id_seq; Type: SEQUENCE SET; Schema: public; Owner: roza
...
--
-- Name: _desc _desc_desc_name_key; Type: CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: _desc _desc_pkey; Type: CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: card card_pkey; Type: CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: horoscopes horoscopes_pkey; Type: CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: users unique_username; Type: CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: users users_username_key; Type: CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: usersы usersы_pkey; Type: CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: usersы usersы_username_key; Type: CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: card card_fk_desc_name_fkey; Type: FK CONSTRAINT; Schema: public; Owner: roza
...
--
-- Name: horoscopes horoscopes_username_fkey; Type: FK CONSTRAINT; Schema: public; Owner: roza
